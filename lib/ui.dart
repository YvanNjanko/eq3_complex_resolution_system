...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Cubic Equation Solver in C',
      theme: ThemeData(
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Cubic Equation Solver in C'),
      ),
      body: Padding(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                if (a == 0 && b == 0 && c == 0 && d == 0) {
                  setState(() {
                    _result = 'Tous les coefficients ne peuvent etre egale a 0';
                  });
                } else if (a == 0) {
                  setState(() {
                    _result = 'le coefficient a ne peut etre egale a 0';
                  });
                } else {
                  ...
                  setState(() {
                    _result =
                        'Solutions: ${solutions.map((c) => c.toString()).join(', ')}';
                  });
                }
              },
              child: Text('Resoudre'),
